import{d as x,a as be,b as we,g as Te,_ as ke,C as ye,r as Z,c as Ee,S as Ae,F as Oe,u as Ue}from"./index.esm-06e63244.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=p.makeFromUrl(t,n)}catch{return new p(t,"")}if(s.path==="")return s;throw Fe(t)}static makeFromUrl(t,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function o(g){g.path.charAt(g.path.length-1)==="/"&&(g.path_=g.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+r+i,"i"),u={bucket:1,path:3};function c(g){g.path_=decodeURIComponent(g.path)}const d="v[A-Za-z0-9_]+",R=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",b=new RegExp(`^https?://${R}/${d}/b/${r}/o${m}`,"i"),w={bucket:1,path:3},U=n===re?"(?:storage.googleapis.com|storage.cloud.google.com)":n,_="([^?#]*)",I=new RegExp(`^https?://${U}/${r}/${_}`,"i"),T=[{regex:a,indices:u,postModify:o},{regex:b,indices:w,postModify:c},{regex:I,indices:{bucket:1,path:2},postModify:c}];for(let g=0;g<T.length;g++){const D=T[g],F=D.regex.exec(t);if(F){const Re=F[D.indices.bucket];let M=F[D.indices.path];M||(M=""),s=new p(Re,M),D.postModify(s);break}}if(s==null)throw Be(t);return s}}class Ve{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function We(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function u(){return a===2}let c=!1;function d(..._){c||(c=!0,t.apply(null,_))}function R(_){r=setTimeout(()=>{r=null,e(b,u())},_)}function m(){o&&clearTimeout(o)}function b(_,...I){if(c){m();return}if(_){m(),d.call(null,_,...I);return}if(u()||i){m(),d.call(null,_,...I);return}s<64&&(s*=2);let T;a===1?(a=2,T=0):T=(s+Math.random())*1e3,R(T)}let w=!1;function U(_){w||(w=!0,m(),!c&&(r!==null?(_||(a=2),clearTimeout(r),R(0)):_||(a=1)))}return R(0),o=setTimeout(()=>{i=!0,U(!0)},n),U}function ze(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ke(e){return e!==void 0}function Xe(e){return typeof e=="object"&&!Array.isArray(e)}function W(e){return typeof e=="string"||e instanceof String}function J(e){return z()&&e instanceof Blob}function z(){return typeof Blob<"u"&&!Ue()}function q(e,t,n,s){if(s<t)throw j(`Invalid value for '${e}'. Expected ${t} or greater.`);if(s>n)throw j(`Invalid value for '${e}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C(e,t,n){let s=t;return n==null&&(s=`https://${t}`),`${n}://${s}/v0${e}`}function ae(e){const t=encodeURIComponent;let n="?";for(const s in e)if(e.hasOwnProperty(s)){const r=t(s)+"="+t(e[s]);n=n+r+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q="prefixes",ee="items";function bt(e,t,n){const s={prefixes:[],items:[],nextPageToken:n.nextPageToken};if(n[Q])for(const r of n[Q]){const o=r.replace(/\/$/,""),i=e._makeStorageReference(new p(t,o));s.prefixes.push(i)}if(n[ee])for(const r of n[ee]){const o=e._makeStorageReference(new p(t,r.name));s.items.push(o)}return s}function wt(e,t,n){const s=K(n);return s===null?null:bt(e,t,s)}class v{constructor(t,n,s,r){this.url=t,this.method=n,this.handler=s,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me="storage";function zt(e,t,n){return e=x(e),Ct(e,t,n)}function Kt(e){return e=x(e),Dt(e)}function Xt(e){return e=x(e),Lt(e)}function Gt(e){return e=x(e),vt(e)}function Yt(e,t){return e=x(e),Ht(e,t)}function Zt(e=Te(),t){e=x(e);const s=be(e,me).getImmediate({identifier:t}),r=we("storage");return r&&jt(s,...r),s}function jt(e,t,n,s={}){$t(e,t,n,s)}function qt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new Y(n,s,r,t,Ae)}function Vt(){ke(new ye(me,qt,"PUBLIC").setMultipleInstances(!0)),Z(ne,se,""),Z(ne,se,"esm2017")}Vt();export{Xt as a,Gt as d,Zt as g,Kt as l,Yt as r,zt as u};
