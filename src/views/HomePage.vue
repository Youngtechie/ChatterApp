...
<template>
    ...
    <main v-else id="HomePage">
        <header>
            ...
            <RouterLink to="/write"
                :class="[{ writeBtn: true }, { Novisibility: !store.signedUser.isLogined && store.signedUser.length > 0 }]">
                <button>Write</button>
            </RouterLink>
            <h1>Chatter</h1>
